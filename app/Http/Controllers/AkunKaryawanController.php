...
->join('users', 'users.idusers', '=', 'karyawans.idakun')
->join('posisis', 'karyawans.id_posisi', '=', 'posisis.id')->select('karyawans.*', 'perusahaans.nama_perusahaan', 'bagians.nama_bagian','posisis.nama_posisi','users.username','users.pass_text')
->where('karyawans.idusers', $idusers)->get(); 
        //render view with posts
        return view('akunkaryawan.index', compact('data'));
        }else{
            return view('login');
        }
...
$idusers=Auth::user()->idusers;
  ...
  */
    ...
    public function edit(string $id): View
    {
		if (Auth::check()) {
        //get post by ID
        $akunkaryawan = \DB::table('users')->where('idusers', '=', $id)->get();
		

        //render view with post
        return view('akunkaryawan.edit', compact('akunkaryawan'));
        }else{
            return view('login');
        }
    }
