...
->join('absensis', 'absensis.id_karyawan', '=', 'karyawans.id')
->join('perusahaans', 'karyawans.id_perusahaan', '=', 'perusahaans.id')
->join('bagians', 'karyawans.id_bagian', '=', 'bagians.id')
->join('posisis', 'karyawans.id_posisi', '=', 'posisis.id')->select('absensis.*', 'perusahaans.nama_perusahaan', 'bagians.nama_bagian','posisis.nama_posisi','karyawans.nama','karyawans.jekel')
