...
<div align="center">
<a href="{{ route('absensi.index') }}" class="btn btn-sm btn-primary"><i class="lnr-home" style="font-size:32px; text-align:center;"></i>
<div align="center">Home</div></a>
<a href="" class="btn btn-sm btn-danger"><i class="lnr-calendar-full" style="font-size:32px; text-align:center;"></i>
<div>Cuti</div></a>
<a href="" class="btn btn-sm btn-warning"><i class="lnr-list" style="font-size:32px; text-align:center;"></i>
<div>History</div></a>
<a href="" class="btn btn-sm btn-success"><i class="lnr-picture" style="font-size:32px; text-align:center;"></i>
<div>ID Card</div></a>
<a href="" class="btn btn-sm btn-danger"><i class="lnr-user" style="font-size:32px; text-align:center;"></i>
<div>Profile</div></a>
</div>
<hr>
...
var jarak=(hitungJarak(posisi_1, posisi_2) * 1000);
		...
		if(jarak > jarak_set_p){
			$('#message').html('<div class="alert alert-danger" style="direction:none;">Jarak dengan lokasi Maximal '+ jarak_set_p +' Meter</div>');
		}
	}
}
