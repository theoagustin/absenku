...
<div class="card-body">
   <h5 class="card-title">Form Update Bagian
   ...
   <hr>
                        <form action="{{ route('bagian.update', $bagian->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('id_perusahaan') is-invalid @enderror" name="id_perusahaan" value="{{ old('id_perusahaan', $bagian->id_perusahaan) }}" placeholder="Masukkan Nama Perusahaan">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama_bagian') is-invalid @enderror" name="nama_bagian" value="{{ old('bagian', $bagian->nama_bagian) }}" placeholder="Masukkan Nama Bagian">
