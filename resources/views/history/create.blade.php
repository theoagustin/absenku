    ...
    <div class="app-main__inner m-0 mt-5 p-1">
        ...
        <div class="main-card mb-3 card">
            <div class="card-body">
                ...
                <div align="center">
                    <a href="{{ route('absensi.index') }}" class="btn btn-sm btn-primary"><i class="lnr-home"
                            style="font-size:32px; text-align:center;"></i>
                        <div align="center">Home</div>
                    </a>
                    <a href="" class="btn btn-sm btn-danger"><i class="lnr-calendar-full"
                            style="font-size:32px; text-align:center;"></i>
                        <div>Cuti</div>
                    </a>
                    <a href="" class="btn btn-sm btn-warning"><i class="lnr-list"
                            style="font-size:32px; text-align:center;"></i>
                        <div>History</div>
                    </a>
                    <a href="" class="btn btn-sm btn-success"><i class="lnr-picture"
                            style="font-size:32px; text-align:center;"></i>
                        <div>ID Card</div>
                    </a>
                    <a href="" class="btn btn-sm btn-danger"><i class="lnr-user"
                            style="font-size:32px; text-align:center;"></i>
                        <div>Profile</div>
                    </a>
                </div>
                ...
                <form action="{{ route('absensi.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <table id="tabasen" width="100%" border="0" cellspacing="0" cellpadding="0"
                        style="display:none;">
                        <tr>
                        ...
                        @foreach ($absensi as $cek_absen)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if($cek==''){
		$act='new';?>
                                    <button type="submit" id="save" class="btn btn-md btn-primary">Absen
                                        Masuk</button>
                                    <?php }else{
		$act='edit';?>

                                    <button type="submit" id="update" class="btn btn-md btn-danger">Absen
                                        Keluar</button>
                                    <?php }?>
