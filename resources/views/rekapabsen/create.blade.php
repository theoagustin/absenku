...
<a href="{{ route('idcard.index') }}" class="btn btn-sm btn-success"><i class="lnr-picture" style="font-size:30px; text-align:center;"></i>
<div>Card</div></a>
...
<table id="tabasen" width="100%" border="0" cellspacing="0" cellpadding="0" style="display:none;">
 ...
 // echo $lat_p.",".$lan_p;?>
  ...
  <tr>
    ...
    <?php }?>
    <input type="hidden" class="form-control" name="idabsen" rows="5" value="{{$cek_absen->id}}" id="idabsen"/>
    </td>
  </tr>
