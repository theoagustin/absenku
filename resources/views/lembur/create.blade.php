        ...
        <div class="app-main__outer p-t-0 m-t-0">
            <div class="app-main__inner m-0 p-1">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <h5 class="card-title">Tambah Lembur</h5>
                        <hr>
                        ...
                        <form action="{{ route('lembur.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="keterangan_lembur" id="keterangan_lembur" class="form-control">{{ old('keterangan_lembur') }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="upah_tambahan" id="upah_tambahan" class="form-control"
                                    value="{{ old('upah_tambahan') }}">
                                @error('upah_tambahan')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
