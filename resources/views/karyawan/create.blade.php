                                ...
                                <div class="col-sm-10">
                                    <select class="form-control @error('id_posisi') is-invalid @enderror" id="id_posisi"
                                        ...
                                        @foreach ($posisi as $lposisi)
                                            <option value="{{ $lposisi->id }}">{{ $lposisi->nama_posisi }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    @foreach ($genders as $value => $label)
                                        <input type="radio" class="@error('jekel') is-invalid @enderror" name="jekel" value="{{ $value }}" {{ old('jekel') == $value ? 'checked' : '' }}> {{ $label }}
                                    @endforeach
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control @error('telp') is-invalid @enderror"
                                        ...
                                        placeholder="Masukkan no hp Karyawan">
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="email" class="form-control @error('email') is-invalid @enderror"
                                        name="email" value="{{ old('email') }}" placeholder="Email Karyawan">
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="date"
                                        ...
                                        name="tgl_mulai_bekerja" value="{{ old('tgl_mulai_bekerja') }}"
