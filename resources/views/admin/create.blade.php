                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('perusahaan.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('content') is-invalid @enderror" name="alamat" rows="5"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"
                                    class="form-control @error('nama_perusahaan') is-invalid @enderror" name="owner"
                                    value="{{ old('owner') }}" placeholder="Masukkan Nama Owner">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"
                                    class="form-control @error('nama_perusahaan') is-invalid @enderror" name="bidang"
                                    value="{{ old('bidang') }}" placeholder="Masukkan Nama Bidang">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control @error('content') is-invalid @enderror"
                                    name="email" rows="5" placeholder="Masukkan Email"
                                    value="{{ old('email') }}" />
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('telp') is-invalid @enderror"
                                    name="telp" rows="5" placeholder="Masukkan Email"
                                    value="{{ old('telp') }}" />
