...
<div class="card-body">
<h5 class="card-title">Data Gaji Karyawan
</h5>
                ...
                <table width="100%" id="example" class="table table-hover table-striped table-bordered" >
				  ...
				  foreach($conn->get_results("select *from $tbname $filter ORDER BY id ASC")as $row){
                    ...
                    <tr>
                      ...
                      <td><button type="button" onclick="OpenFEdit('<?php echo $id;?>');" data-toggle="modal" data-target=".bd-example-modal-lg"   class="btn-shadow  btn btn-info">Bayar </button>
</td>
                    </tr>
                    <?php $no++;
					}?>
...
function OpenFEdit(x) {
 var url ="<?php echo './base/penggajian/form.php?act=edit&id=';?>"+x; 
